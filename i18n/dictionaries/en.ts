...
export const enTranslations: Record<TranslationKey, string> = {
	...
	'appearance.clock.face': 'Face',
	'appearance.clock.back': 'Back',
	'appearance.clock.pinUp': 'Pin U',
	'appearance.clock.pinDown': 'Pin D',
	'appearance.clock.wheelF': 'Wheel F',
	'appearance.clock.wheelB': 'Wheel B',
	'appearance.clock.digitF': 'Digit F',
	'appearance.clock.digitB': 'Digit B',
	...
	'stats.noPbs': 'No PBs found for this statistic',
	...
	'import.deduplicate': 'Deduplicate (Skip existing matches)',
	...
	'offline.title': 'Download & Offline Use',
	'offline.close': 'Close download options',
	'offline.pwa.title': 'Install the web app (PWA)',
	'offline.pwa.description': 'No download file is needed. Use your browser’s Install app or Add to Home screen option, then CMOSTimer can be opened and used offline.',
	'offline.android.title': 'Android',
	'offline.android.description': 'Download the latest APK for Android devices.',
	'offline.windows.title': 'Windows',
	'offline.windows.description': 'Choose the Windows installer or portable desktop build.',
	'offline.linux.title': 'Linux',
	'offline.linux.description': 'Download the latest AppImage desktop build.',
	'offline.buildsHint': 'Native downloads open the CMOSTimer builds directory in a new tab.',
	...
	'pbsheet.search': 'Search sessions to add...',
	...
	'about.thanks': 'Thanks to everyone who helped me by testing and providing feedback, especially these users:',
